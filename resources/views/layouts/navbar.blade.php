...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <div class="header-logo">
            <a href="#">
                <img class="d-none d-lg-block" src="{{ asset('assets/images/logo-dark.png') }}" alt="...">
{{--                <img class="d-none d-lg-block" src="{{ asset('assets/media/image/white-logo.png') }}" alt="...">--}}
{{--                <img class="d-none d-lg-block" src="{{ asset('assets/images/logo.png') }}" alt="...">--}}
                <img class="d-lg-none d-sm-block" src="{{ asset('assets/media/image/mobile-logo.png') }}" alt="...">
            </a>
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                        <div class="dropdown-menu-title text-center"
                            ...
                            <h6 class="text-uppercase font-size-12 m-b-0">Kuja</h6>
                        </div>
                        <div class="dropdown-menu-body">
                            <ul class="list-group list-group-flush">
